...
const GenAISummaryCard: FC<GenAISummaryCardProps> = ({ collaboratorId, cycle, onSummaryGenerated }) => {
  const toast = useGlobalToast();
  const { generateSummary, checkExistingSummary, clearSummary, summary, loading, checkingExisting, error } =
    useGenAISummary();
            ...
            <div>
              ...
              <div className='bg-white rounded-lg p-3 border border-blue-100'>
                ...
                <ul className='text-sm text-blue-800 space-y-1 mt-2'>
                  <li>
                    • <strong>Consistência</strong> entre diferentes tipos de avaliação
                  </li>
                  <li>
                    • <strong>Padrões</strong> nas notas e feedbacks
                  </li>
                  <li>
                    • <strong>Pontos fortes</strong> e áreas de desenvolvimento
                  </li>
                  <li>
                    • <strong>Recomendação estratégica</strong> para equalização
                  </li>
                </ul>
              </div>
            </div>
