...
const ProjectInfoCardBase = ({ title, leftContent, rightContent, className = 'bg-white text-gray-800' }: BaseCardProps) => {
  return (
    <div className={`flex flex-col w-full p-6 shadow-md rounded-tl-2xl rounded-br-2xl ${className}`}>
...
export default ProjectInfoCardBase;
