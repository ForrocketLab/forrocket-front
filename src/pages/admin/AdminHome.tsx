  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Acesso ao RH */}
        <Link to="/rh" className="group">
          <div className="bg-white rounded-lg p-6 shadow-sm border hover:shadow-md transition-all duration-200 group-hover:border-teal-200">
            <div className="flex items-center justify-between mb-4">
            ...
            <p className="text-gray-600 text-sm">
              Acesso às funcionalidades de RH: dashboard, colaboradores e critérios.
            </p>
      ...
      {activeCycle && (
        <div className="mt-8 bg-white rounded-lg p-6 shadow-sm border">
          <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
            ...
            Ações Rápidas - Ciclo Ativo
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link 
              to={`/admin/cycles/${activeCycle.id}/manage`}
              className="p-4 border border-blue-200 rounded-lg hover:bg-blue-50 transition-colors"
            >
              <div className="flex items-center gap-3">
                <Calendar className="h-5 w-5 text-blue-600" />
                <div>
                  <div className="font-medium text-gray-900">Gerenciar Ciclo</div>
                  <div className="text-sm text-gray-600">Editar deadlines e configurações</div>
                </div>
              </div>
            </Link>
            
            <Link 
              to="/admin/phase-control"
              className="p-4 border border-orange-200 rounded-lg hover:bg-orange-50 transition-colors"
            >
              <div className="flex items-center gap-3">
                <Zap className="h-5 w-5 text-orange-600" />
                <div>
                  <div className="font-medium text-gray-900">Avançar Fase</div>
                  <div className="text-sm text-gray-600">Controle manual de fases</div>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium text-gray-900">Criar Usuário</div>
                  <div className="text-sm text-gray-600">Adicionar novo colaborador</div>
                </div>
              </div>
            </Link>
          </div>
